...
public class ServiceUser {
    ...
    */
    public void insertUser(ModelNguoiDung user)throws SQLException{
        ...
        PreparedStatement p1=conn.prepareStatement("SELECT MAX(ID_ND) as ID_ND FROM NguoiDung");
        ...
        PreparedStatement p=conn.prepareStatement(sql_ND);
    ...
    */
    public void doneVerify(int userID,String name) throws SQLException{
        ...
        PreparedStatement p1 = conn.prepareStatement(sql_ND);
        p1.setInt(1, userID);
        p1.execute();
        //Lấy id của Khách Hàng tiếp theo
        int id=0;
        String sql_ID="SELECT MAX(ID_KH) as ID FROM KhachHang";
        PreparedStatement p_id = conn.prepareStatement(sql_ID);
        ...
        PreparedStatement p2=conn.prepareStatement(sql_KH);
        p2.setInt(1, id);
        p2.setString(2, name);

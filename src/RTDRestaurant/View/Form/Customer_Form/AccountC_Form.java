...
public class AccountC_Form extends javax.swing.JPanel {
    ...
    public AccountC_Form() throws SQLException {
        service = new ServiceCustomer();
        initComponents();

    }

    public AccountC_Form(ModelNguoiDung user) throws SQLException {
        this.user = user;
        initComponents();
        init();
    }
    ...
    private void confirmRename(String message) throws SQLException {

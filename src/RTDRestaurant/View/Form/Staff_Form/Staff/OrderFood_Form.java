...
public class OrderFood_Form extends javax.swing.JPanel {
    ...
    public OrderFood_Form(ModelNguoiDung user,ModelNhanVien staff,ModelBan table,MainForm main) throws SQLException {
        this.user=user;
        this.staff=staff;
        this.table=table;
        this.main=main;
    ...
    public void searchFood(String txt) throws SQLException {
        panel.removeAll();
        for (ModelMonAn data : list) {

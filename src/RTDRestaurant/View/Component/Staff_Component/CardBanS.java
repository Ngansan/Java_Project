...
public class CardBanS extends javax.swing.JPanel {
    ...
    public CardBanS(ModelNguoiDung user,ModelNhanVien staff,ModelBan table,MainForm main) throws SQLException {
        this.user=user;
        this.staff=staff;
        this.table = table;
        this.main=main;
                ...
                cmdAdj.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        try {
                            ...
                            Logger.getLogger(CardBanS.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }
                });
            }

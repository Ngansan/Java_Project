...
public class Main_WarehouseStaff_Frame extends javax.swing.JFrame {
    ...
    public Main_WarehouseStaff_Frame() throws HeadlessException, SQLException {
        initComponents();
        init();
    ...
    public Main_WarehouseStaff_Frame(ModelNguoiDung user) throws SQLException {
        this.user = user;
        initComponents();
        init();
        setTitle("Royal TheDreamers Restaurant");
            ...
            public void menuSelected(int menuIndex, int subMenuIndex) {
                switch (menuIndex) {
                    ...
                    try {
                        ...
                        Logger.getLogger(Main_WarehouseStaff_Frame.class.getName()).log(Level.SEVERE, null, ex);
                    }
                    }
                    case 1 -> {
                    try {
